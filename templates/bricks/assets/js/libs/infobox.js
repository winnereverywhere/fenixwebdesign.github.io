...
if(typeof opt_opts.visible==='undefined'){if(typeof opt_opts.isHidden==='undefined'){opt_opts.visible=true}else{opt_opts.visible=!opt_opts.isHidden}}
...
InfoBox.prototype.createInfoBoxDiv_=function(){var i
var events
var bw
var me=this
...
var keyHandler=function(e){if(e.key==='Escape'){e.preventDefault()
e.stopPropagation()
...
this.div_.setAttribute('aria-modal','false')
this.setBoxStyle_()
...
if(this.addressId){this.div_.setAttribute('data-brx-address-id',this.addressId)}
if(this.mapElId){this.div_.setAttribute('data-brx-sync-map-id',this.mapElId)}
if(this.interactionSelector){this.div_.setAttribute('data-interaction-loop-id',this.interactionSelector)}
...
for(i=0;i<events.length;i++){this.eventListeners_.push(this.div_.addEventListener(events[i],cancelHandler))}
...
this.closeListener_=closeBox.addEventListener('click',this.getCloseClickHandler_())}else{this.closeListener_=null}}
...
if(map.panToBounds.length==2){var padding={left:0,right:0,top:0,bottom:0}
...
map.panToBounds(new google.maps.LatLngBounds(this.position_),padding)}else{var mapDiv=map.getDiv()
...
InfoBox.prototype.setVisible=function(isVisible){this.isHidden_=!isVisible
...
InfoBox.prototype.getVisible=function(){var isVisible
if(typeof this.getMap()==='undefined'||this.getMap()===null){isVisible=false}else{isVisible=!this.isHidden_}
return isVisible}
InfoBox.prototype.getWidth=function(){var width=null
if(this.div_){width=this.div_.offsetWidth}
return width}
InfoBox.prototype.getHeight=function(){var height=null
...
if(anchor){this.position_=anchor.position
this.moveListener_=google.maps.event.addListener(anchor,'position_changed',function(){me.setPosition(this.position)})}
this.setMap(map)
if(this.div_){setTimeout(function(){me.div_.focus()},100)
this.panBox_(this.disableAutoPan_)}
google.maps.event.trigger(this,'infobox_opened')}
InfoBox.prototype.close=function(){var i
...
this.contextListener_=null}
if(this.keyListener_){this.div_.removeEventListener('keyup',this.keyListener_)
this.keyListener_=null}
this.setMap(null)
