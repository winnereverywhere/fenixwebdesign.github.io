...
var e=u.fn.select2.amd;var t,n,r,h,o,s,f,g,m,v,y,_,i,a,b;function w(e,t){return i.call(e,t);}
...
if('.'===(p=e[u]))
e.splice(u,1),(u-=1);else if('..'===p){if(0===u||(1===u&&'..'===e[2])||'..'===e[u-1])
...
if(o)break;!l&&g&&g[r]&&((l=g[r]),(c=u));}!o&&l&&((o=l),(a=c)),o&&(n.splice(0,a,o),(e=n.join('/')));}
return e;}
...
(d[l]=g.exports(e)),(u=!0);else if('module'===o)
i=d[l]=g.module(e);else if(w(m,o)||w(v,o)||w(_,o))
d[l]=D(o);else{if(!a.p)
...
for(var i in t)
n.call(t,i)&&(e[i]=t[i]);return((r.prototype=t.prototype),(e.prototype=new r()),(e.__super__=t.prototype),e);}),(i.Decorate=function(r,i){var e=u(i),t=u(r);function o(){var e=Array.prototype.unshift,t=i.prototype.constructor.length,n=r.prototype.constructor;0<t&&(e.call(arguments,r.prototype.constructor),(n=i.prototype.constructor)),n.apply(this,arguments);}
...
return((t.prototype.normalizePlaceholder=function(e,t){return('string'==typeof t&&(t={id:'',text:t}),t);}),(t.prototype.createPlaceholder=function(e,t){var n=this.selectionContainer();return(n.html(this.display(t)),n.addClass('select2-selection__placeholder').removeClass('select2-selection__choice'),n);}),(t.prototype.update=function(e,t){var n=1==t.length&&t[0].id!=this.placeholder.id;if(1<t.length||n)
return e.call(this,t);this.clear();var r=this.createPlaceholder(this.placeholder);this.$selection.find('.select2-selection__rendered').append(r);}),t);}),e.define('select2/selection/allowClear',['jquery','../keys','../utils'],function(i,r,a){function e(){}
...
1)+'em');this.$search.css('width',e);}),e);}),e.define('select2/selection/eventRelay',['jquery'],function(s){function e(){}
...
return((i.element.selected=!0),void this.$element.trigger('input').trigger('change'));if(this.$element.prop('multiple'))
this.current(function(e){var t=[];(i=[i]).push.apply(i,e);for(var n=0;n<i.length;n++){var r=i[n].id;-1===l.inArray(r,t)&&t.push(r);}
o.$element.val(t),o.$element.trigger('input').trigger('change');});else{var e=i.id;this.$element.val(e),this.$element.trigger('input').trigger('change');}}),(n.prototype.unselect=function(i){var o=this;if(this.$element.prop('multiple')){if(((i.selected=!1),l(i.element).is('option')))
return((i.element.selected=!1),void this.$element.trigger('input').trigger('change'));this.current(function(e){for(var t=[],n=0;n<e.length;n++){var r=e[n].id;r!==i.id&&-1===l.inArray(r,t)&&t.push(r);}
...
i=c.isPlainObject(o)?new s(o):o;n.extend(i);}
...
t.removedNodes&&0<t.removedNodes.length?(n=!0):o.isArray(t)&&o.each(t,function(e,t){if(r._isChangeMutation(e,t))
return!(n=!0);});else n=!0;return n;}}),(d.prototype._syncSubtree=function(e,t){var n=this._isChangeMutation(e,t),r=this;n&&this.dataAdapter.current(function(e){r.trigger('selection:update',{data:e,});});}),(d.prototype.trigger=function(e,t){var n=d.__super__.trigger,r={open:'opening',close:'closing',select:'selecting',unselect:'unselecting',clear:'clearing',};if((void 0===t&&(t={}),e in r)){var i=r[e],o={prevented:!1,name:e,args:t,};if((n.call(this,i,o),o.prevented))
